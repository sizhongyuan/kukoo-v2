package com.kukoo.logsystem.controller;
...
public class LogController {
	...
	/** 登入页 */
	public static final String LOGIN_PAGE = "/WEB-INF/logsystem/index.jsp";
	/** 首页 */
	public static final String MAIN_PAGE = "/WEB-INF/logsystem/main.jsp";
	/** 用户session key */

package com.kukoo.logsystem.aop;
...
import com.kukoo.base.util.DateUtils;
import com.kukoo.base.util.UUIDHexGenerator;
import com.kukoo.logsystem.annotation.SystemControllerLog;
import com.kukoo.logsystem.model.Log;
import com.kukoo.logsystem.bean.User;
...
public class SystemLogAspect {
	 ...
	 * Service层切点 
	 */
/*	@Pointcut("@annotation(com.kukoo.logsystem.annotation.SystemServiceLog)")
	public void serviceAspect(){}*/
	
	/**
	 * Controller层切点 注解拦截
	 */
	@Pointcut("@annotation(com.kukoo.logsystem.annotation.SystemControllerLog)")
	public void controllerAspect(){}
	
	/**
	 * 方法规则拦截
	 */
	@Pointcut("execution(* com.kukoo.*.controller.*.*(..))")
...
//	    	String remoteAddr=request.getRemoteAddr();//请求的IP
	    	...
	    	Log log=new Log();
	    	try {
				log.setId(UUIDHexGenerator.getID());
			} catch (Exception e) {
				e.printStackTrace();
			}
	    	log.setTitle(title);

                ...
                <div class="span11">
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <h2><i class="icofont-home"></i> 抽奖机会管理 <small>welcome to Kukoo</small></h2>
                        </div><!-- /content-header -->
                                                ...
                                                <tbody>
                                                    <c:forEach var="index" items="${page.list }" varStatus="status">
                                                    	   <tr class="gradeA">
	                                                        ...
	                                                        <td>${index.lottery_url}</td>
	                                                        <td>${index.lottery_num }</td>
	                                                        <td class="center">${index.create_time }</td>
	                                                        <td class="center">${index.lottery_user_id }</td>
	                                                    </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
	                                                  ...
	                                                  <ul>
	                                                      ...
	                                                      <li><a href="#">Next</a></li> -->
	                                                         <c:if test="${!page.isFirstPage}">
								                                <li><a href="<%=basePath %>/main/showLotteryOpportunityPage?pageNum=${page.firstPage}">首页</a></li>
								                            ...
								                            <c:forEach items="${page.navigatepageNums}" var="navigatepageNum">
								                                ...
								                                <c:if test="${navigatepageNum==page.pageNum}">
								                                    <li class="active"><a href="<%=basePath %>/main/showLotteryOpportunityPage?pageNum=${navigatepageNum}">${navigatepageNum}</a></li>
								                                </c:if>
								                                <c:if test="${navigatepageNum!=page.pageNum}">
								                                    <li><a href="<%=basePath %>/main/showLotteryOpportunityPage?pageNum=${navigatepageNum}">${navigatepageNum}</a></li>
								                                </c:if>
								                            </c:forEach>

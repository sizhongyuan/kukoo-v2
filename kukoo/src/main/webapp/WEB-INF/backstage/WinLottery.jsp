                ...
                <div class="span11">
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <h2><i class="icofont-home"></i> 中奖记录管理 <small>welcome to Kukoo</small></h2>
                        </div><!-- /content-header -->
                                            ...
                                            <table id="datatablestools" class="table table-hover responsive">
                                                ...
                                                <tbody>
                                                    <c:forEach var="index" items="${page.list }" varStatus="status">
                                                    	   <tr class="gradeA">
	                                                        <td>${index.lottery_id}</td>
	                                                        <td>${index.name}</td>
	                                                        <td>${index.win_user_id }</td>
	                                                        <td class="center">${index.win_phone }</td>
	                                                        <td class="center">${index.win_time }</td>
	                                                        <c:if test="${index.is_give_out==0}">
	                                                        	<td class="center">未发放</td>	
	                                                        </c:if>
	                                                        <c:if test="${index.is_give_out==1}">
	                                                        	<td class="center">已发放</td>	
	                                                        </c:if>
	                                                    </tr>
                                                    </c:forEach>
                                                </tbody>
	                                                  ...
	                                                  <ul>
	                                                      ...
	                                                      <li><a href="#">Next</a></li> -->
	                                                         <c:if test="${!page.isFirstPage}">
								                                <li><a href="<%=basePath %>/main/showWinLotteryPage?pageNum=${page.firstPage}">首页</a></li>
								                            ...
								                            <c:forEach items="${page.navigatepageNums}" var="navigatepageNum">
								                                ...
								                                <c:if test="${navigatepageNum==page.pageNum}">
								                                    <li class="active"><a href="<%=basePath %>/main/showWinLotteryPage?pageNum=${navigatepageNum}">${navigatepageNum}</a></li>
								                                </c:if>
								                                <c:if test="${navigatepageNum!=page.pageNum}">
								                                    <li><a href="<%=basePath %>/main/showWinLotteryPage?pageNum=${navigatepageNum}">${navigatepageNum}</a></li>
								                                </c:if>
								                            </c:forEach>

                        ...
                        <%-- ////// --%>
                          <div class="tab-content">
                            <div class="tab-pane fade in active font-微软雅黑 font-12" id="Policy">
                              ...
                              <p>澳大利亚189独立技术移民签证（Skilled Independent visa (subclass 189) (Points-tested) stream），俗称独立技术移民，不需要州担保、雇主以及亲属担保就可以申请。申请189签证成功后可以无限期居住在澳洲，申请人及其家人可以在这里作为永久居民去工作、学习、加入医疗保险、担保亲属、申请澳大利亚国籍等。</p>
                              <h5 class="font-微软雅黑">
                                <strong>项目要点</strong>
                              </h5>
                              <p>申请人的职业必须在澳洲的MLTSSL职业列表里面，按照评分标准可以达到60分（某些职业可能需要65甚至更高分数才能获邀），就有机会申请189独立技术移民申请。189技术移民不需要州或亲属担保，移民成功后可在澳大利亚任何地区生活，工作和学习，没有任何限制。</p>
                            ...
                            <div class="tab-pane fade font-微软雅黑 font-12" id="Requirement">
                              ...
                              <ul class="icon-list mb-20 font-微软雅黑">
                                <li>
                                  <i class="fa fa-angle-right"></i>职业必须在MLTSSL移民职业列表上，工作经验需要与提名的职业相关才能算分；</li>
                                <li>
                            ...
                            <div class="tab-pane fade font-微软雅黑 font-12" id="process">
                              ...
                              <div class="post-prev-info font-12">
                                ...
                                <h5 class="font-微软雅黑">4.&nbsp 递交签证申请</h5>
                                <ul class="icon-list mb-10 font-微软雅黑">
                                  <li>
                                    <i class="fa fa-angle-right"></i>收到签证邀请后在60天内递交签证申请；</li>
                                  <li>
                                ...
                                <h5 class="font-微软雅黑">6.&nbsp 配偶缴纳语言费或者补交雅思成绩</h5>
                                <ul class="icon-list mb-10 font-微软雅黑">
                                  <li>
                                ...
                                <detail-dura :ds="dura._189" class="pt-0 pl-0"></detail-dura>

                              </div>
                              <div class="tab-pane fade font-微软雅黑 font-12" id="fee">
                                <p>
                                  <detail-pay :ds="pay._189"></detail-pay>
                                </p>
                              </div>
                              <div class="tab-pane fade font-微软雅黑 font-12" id="documents">
                                <p>
                                  <detail-doc :ds="doc._189"></detail-doc>
                                </p>
                              </div>
                            </div>
                          </div>
